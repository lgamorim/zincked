...
/// <summary>
/// The outcome of parsing the command line: either the two resolved folders and sync mode, a
/// request for help, or an error describing why parsing failed.
/// </summary>
...
/// <param name="Mode">The resolved sync mode. Defaults to <see cref="SyncMode.Bidirectional"/>.</param>
    ...
    string? ErrorMessage)
{
    ...
    public static CommandLineParseResult Help() =>
        new(null, null, SyncMode.Bidirectional, true, null);
    ...
    public static CommandLineParseResult Failure(string message) =>
        new(null, null, SyncMode.Bidirectional, false, message);

    /// <summary>Creates a successful result carrying the two resolved folders and sync mode.</summary>
    public static CommandLineParseResult Success(string gameFolder, string cloudFolder, SyncMode mode) =>
        new(gameFolder, cloudFolder, mode, false, null);
}
